...
# Callbacks
checkpoint = ModelCheckpoint(filepath='C:/Users/Ghadeer/Desktop/projects/final-final/VGG19/one neurial/best_weights.hdf5', save_best_only=True, save_weights_only=True)
lr_reduce = ReduceLROnPlateau(monitor='val_loss', factor=0.3, patience=2, verbose=2, mode='max')
early_stop = EarlyStopping(monitor='val_loss', min_delta=0.1, patience=1, mode='min', verbose=0)
call = CSVLogger('C:/Users/Ghadeer/Desktop/projects/final-final/VGG19/one neurial/mytrain.csv', separator=',', append=False)
tensorboard = TensorBoard(log_dir='/CallBacks-Final-Final/VGG19', histogram_freq=1, write_graph=True, write_images=True)
...
history = model.fit(
                    ...
                    callbacks=[checkpoint, lr_reduce#, early_stop
                               , call, tensorboard])
#save model
model.save('C:/Users/Ghadeer/Desktop/projects/final-final/VGG19/one neurial/arch.hdf5')
# Set the path to the saved model
model_path = 'C:/Users/Ghadeer/Desktop/projects/final-final/VGG19/one neurial/arch.hdf5'
